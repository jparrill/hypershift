...
type HostedControlPlaneSpecApplyConfiguration struct {
	...
	KasCustomKubeconfig              *CustomKubeconfigApplyConfiguration                  `json:"kasCustomKubeconfig,omitempty"`
...
// WithKasCustomKubeconfig sets the KasCustomKubeconfig field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the KasCustomKubeconfig field is set to the value of the last call.
func (b *HostedControlPlaneSpecApplyConfiguration) WithKasCustomKubeconfig(value *CustomKubeconfigApplyConfiguration) *HostedControlPlaneSpecApplyConfiguration {
	b.KasCustomKubeconfig = value
	return b
}
