...
func NewRunCommand() *cobra.Command {
	...
	cmd.Flags().StringVar(&opts.kubeletConfigJsonPath, "kubelet-config-json-path", opts.kubeletConfigJsonPath, "The path to the kubelet's config.json file in the DataPlane.")
	cmd.Flags().StringVar(&opts.globalPSSecretName, "global-ps-secret-name", opts.globalPSSecretName, "The name of the global pull secret secret in the DataPlane.")
