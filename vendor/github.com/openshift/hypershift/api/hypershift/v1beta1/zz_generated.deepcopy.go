...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomKubeconfig) DeepCopyInto(out *CustomKubeconfig) {
	*out = *in
	if in.SecretRef != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomKubeconfig.
func (in *CustomKubeconfig) DeepCopy() *CustomKubeconfig {
	if in == nil {
		return nil
	}
	out := new(CustomKubeconfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HostedControlPlaneSpec) DeepCopyInto(out *HostedControlPlaneSpec) {
	*out = *in
	...
	if in.KasCustomKubeconfig != nil {
		in, out := &in.KasCustomKubeconfig, &out.KasCustomKubeconfig
		*out = new(CustomKubeconfig)
		(*in).DeepCopyInto(*out)
	}
	if in.Services != nil {
