...
func RenconcileMgmtImageRegistryOverrides(ctx context.Context, capChecker capabilities.CapabiltyChecker, client crclient.Client, registryOverrides map[string]string) (*releaseinfo.ProviderWithOpenShiftImageRegistryOverridesDecorator, *hyperutil.RegistryClientImageMetadataProvider, error) {
	var (
